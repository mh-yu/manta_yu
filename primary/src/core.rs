...
impl Core {
    ...
    async fn broadcast_waiting_weak_certificates(
        ...
        for digest in waiting_ids {
            ...
            let weak_certificate = self
                ...
                .get_mut(&digest)
                .and_then(|aggregator| {
                    aggregator.weak_certificate_if_ready(validity_threshold, &header)
                });
    ...
    async fn update_adaptive_wait_round(
        ...
        let should_broadcast_weak_certificates = !had_existing_state || observed_progress;
        if !had_existing_state {
        ...
        if should_broadcast_weak_certificates {
