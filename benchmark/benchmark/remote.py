...
class Bench:
    ...
    def _config(self, hosts, node_parameters, bench_parameters):
        ...
        committee = Committee(
            ...
            jp.get('reference', 4),
            jp.get('coverage', 7),
            allow_cross_step_weak_edges=jp.get('allow_cross_step_weak_edges', True),
            enable_fast_coin=jp.get('enable_fast_coin', False),
            solid_commit_trigger_on_solid_step=jp.get(
                'solid_commit_trigger_on_solid_step', False
            ),
            enable_commit_recheck=jp.get('enable_commit_recheck', True),
            fast_coin_candidate_threshold=jp.get('fast_coin_candidate_threshold', 0),
            solid_candidate_threshold=jp.get('solid_candidate_threshold', 0),
        )
